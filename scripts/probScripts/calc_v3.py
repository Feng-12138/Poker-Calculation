...
if __name__ == "__main__":
    ...
    curPlayerComb, allCombs, all_combs_count_dict, all_possible_hand_card_dict = find_best_combs([7, 10], [5, 7, 7, 14])
    ...
    result = calculate_prob(curPlayerComb, allCombs, all_combs_count_dict, [7, 10], best_comb_desk_map_current, desk_best_comb_map_other, best_comb_hand_card_dict, all_possible_hand_card_dict, 3)
